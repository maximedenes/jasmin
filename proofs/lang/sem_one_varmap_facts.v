...
Proof.
  exact:
    (@sem_Ind _ p extra_free_registers var_tmp Pc Pi Pi_r Pfun
...
Proof.
  exact:
    (@sem_I_Ind _ p extra_free_registers var_tmp Pc Pi Pi_r Pfun
...
Proof.
  exact:
    (@sem_call_Ind _ p extra_free_registers var_tmp Pc Pi Pi_r Pfun
