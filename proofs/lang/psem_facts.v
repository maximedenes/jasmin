...
Proof.
  by apply
    (@sem_Ind _ _ _ _ _ _ Pc Pi_r Pi Pfor Pfun
              mem_equiv_nil
              mem_equiv_cons
              mem_equiv_mkI
              mem_equiv_assgn
...
Proof.
  by apply
    (@sem_I_Ind _ _ _ _ _ _ Pc Pi_r Pi Pfor Pfun
                mem_equiv_nil
                mem_equiv_cons
                mem_equiv_mkI
                mem_equiv_assgn
...
Proof.
  by apply
    (@sem_call_Ind _ _ _ _ _ _ Pc Pi_r Pi Pfor Pfun
                   mem_equiv_nil
                   mem_equiv_cons
                   mem_equiv_mkI
                   mem_equiv_assgn
...
Proof.
  move => h.
  exact: (@sem_Ind _ T pT sCP p ev Pc Pi_r Pi Pfor Pfun sem_deter_nil sem_deter_cons sem_deter_mkI sem_deter_asgn sem_deter_opn sem_deter_if_true sem_deter_if_false sem_deter_while_true sem_deter_while_false sem_deter_for sem_deter_for_nil sem_deter_for_cons sem_deter_call sem_deter_proc _ _ _ h _).
Qed.
...
Proof.
  move => h.
  exact: (@sem_i_Ind _ T pT sCP p ev Pc Pi_r Pi Pfor Pfun sem_deter_nil sem_deter_cons sem_deter_mkI sem_deter_asgn sem_deter_opn sem_deter_if_true sem_deter_if_false sem_deter_while_true sem_deter_while_false sem_deter_for sem_deter_for_nil sem_deter_for_cons sem_deter_call sem_deter_proc _ _ _ h _).
Qed.
...
Proof.
  move => h.
  exact: (@sem_call_Ind _ T pT sCP p ev Pc Pi_r Pi Pfor Pfun sem_deter_nil sem_deter_cons sem_deter_mkI sem_deter_asgn sem_deter_opn sem_deter_if_true sem_deter_if_false sem_deter_while_true sem_deter_while_false sem_deter_for sem_deter_for_nil sem_deter_for_cons sem_deter_call sem_deter_proc _ _ _ _ _ h).
Qed.
